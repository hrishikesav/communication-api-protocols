...
public final class HelloServiceGrpc {
  ...
  public static final String SERVICE_NAME = "com.hrishi.api.grpc.HelloService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.hrishi.api.grpc.HelloRequest,
      com.hrishi.api.grpc.HelloResponse> getHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "hello",
      requestType = com.hrishi.api.grpc.HelloRequest.class,
      responseType = com.hrishi.api.grpc.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.hrishi.api.grpc.HelloRequest,
      com.hrishi.api.grpc.HelloResponse> getHelloMethod() {
    io.grpc.MethodDescriptor<com.hrishi.api.grpc.HelloRequest, com.hrishi.api.grpc.HelloResponse> getHelloMethod;
    if ((getHelloMethod = HelloServiceGrpc.getHelloMethod) == null) {
      synchronized (HelloServiceGrpc.class) {
        if ((getHelloMethod = HelloServiceGrpc.getHelloMethod) == null) {
          HelloServiceGrpc.getHelloMethod = getHelloMethod =
              io.grpc.MethodDescriptor.<com.hrishi.api.grpc.HelloRequest, com.hrishi.api.grpc.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "hello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.hrishi.api.grpc.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.hrishi.api.grpc.HelloResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void hello(com.hrishi.api.grpc.HelloRequest request,
        io.grpc.stub.StreamObserver<com.hrishi.api.grpc.HelloResponse> responseObserver) {
  ...
  public static final class HelloServiceStub
    ...
    /**
     */
    public void hello(com.hrishi.api.grpc.HelloRequest request,
        io.grpc.stub.StreamObserver<com.hrishi.api.grpc.HelloResponse> responseObserver) {
  ...
  public static final class HelloServiceBlockingStub
    ...
    /**
     */
    public com.hrishi.api.grpc.HelloResponse hello(com.hrishi.api.grpc.HelloRequest request) {
  ...
  public static final class HelloServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.hrishi.api.grpc.HelloResponse> hello(
        com.hrishi.api.grpc.HelloRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_HELLO:
          serviceImpl.hello((com.hrishi.api.grpc.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.hrishi.api.grpc.HelloResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.hrishi.api.grpc.HelloRequest,
              com.hrishi.api.grpc.HelloResponse>(
  ...
  private static abstract class HelloServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.hrishi.api.grpc.HelloServiceOuterClass.getDescriptor();
    }
